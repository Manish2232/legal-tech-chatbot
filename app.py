...
st.markdown(
    ...
    <style>
        ...
        @keyframes glowPulse {{
            0%   {{ filter: drop-shadow(0 0 3px rgba(83,230,255,.8)) drop-shadow(0 0 10px rgba(83,230,255,.5))
                            drop-shadow(0 0 20px rgba(157,120,255,.35)); }}
            50%  {{ filter: drop-shadow(0 0 5px rgba(83,230,255,1)) drop-shadow(0 0 16px rgba(83,230,255,.7))
                            drop-shadow(0 0 30px rgba(157,120,255,.55)); }}
            100% {{ filter: drop-shadow(0 0 3px rgba(83,230,255,.8)) drop-shadow(0 0 10px rgba(83,230,255,.5))
                            drop-shadow(0 0 20px rgba(157,120,255,.35)); }}
        }}
        ...
        .lexassist-brand-title {{
            ...
            filter: drop-shadow(0 0 6px rgba(83, 230, 255, .35));
            margin: 0;
            line-height: 1.2;
        }}

        .lexassist-brand-title.main {{
            font-size: 1.9rem;
        }}

        .lexassist-logo-img-sidebar {{
            display: block;
            margin: 0 auto .3rem;
            max-width: 220px;
            width: 100%;
